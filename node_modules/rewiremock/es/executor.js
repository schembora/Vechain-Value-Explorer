    ...
    if (shouldMock(mock, request, parent, parentModule, shouldResult)) {
      ...
      if (mock.mockThrough) {
        ...
        return mockResult(request, mock, function () {
          return Object.assign({}, mock.override, mock.value, { __esModule: mock.original.__esModule });
        });
      }
      ...
      if (mock.allowCallThrough) {
        ...
        return mockResult(request, mock, function () {
          return Object.assign({}, mock.original, mock.value, { __esModule: mock.original.__esModule });
        });
      }
